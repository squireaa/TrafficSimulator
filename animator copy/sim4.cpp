...
int max_time = 100;
double prob_new_vehicle_northbound = .05;
...
void south_green_light() {
    ...
    southbound[0] = headSouthbound[3];
    headSouthbound[3] = nullptr;
...
void south_yellow_light() {
    if (southbound[num_of_sections-1] == nullptr) {
        ...
        if (southbound[num_of_sections-1] == southbound[num_of_sections]) {
            south_green_light();
        } else {
...
void east_green_light() {
    ...
    eastbound[0] = headEastbound[3];
    headEastbound[3] = nullptr;
...
void east_yellow_light() {
    if (eastbound[num_of_sections-1] == nullptr) {
        ...
        if (eastbound[num_of_sections-1] == eastbound[num_of_sections]) {
            east_green_light();
        } else {
...
void west_green_light() {
    ...
    westbound[0] = headWestbound[3];
    headWestbound[3] = nullptr;
...
void west_yellow_light() {
    if (westbound[num_of_sections-1] == nullptr) {
        ...
        if (westbound[num_of_sections-1] == westbound[num_of_sections]) {
            west_green_light();
        } else {
